...
class doctor_info(models.Model):
    ...
    user = models.OneToOneField(
        UserP, on_delete=models.CASCADE, null=True, blank=True, related_name='profile')
    ...
    certificate_image = models.ImageField(
        upload_to='doctors_certificate/', default='doctors_certificate/default.png', null=True, blank=True)
