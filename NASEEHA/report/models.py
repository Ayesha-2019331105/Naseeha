...
from django.db import models
from doctors.models import doctor_info  # Import the DoctorInformation model if it's in a separate file
from hospital.models import Patient  # Import the Patient model if it's in a separate file
