...
class Patient(models.Model):
    ...
    user = models.OneToOneField(
        UserP, on_delete=models.CASCADE, null=True, blank=True, related_name='patient')
    ...
    featured_image = models.ImageField(
        upload_to='edit_profile/', default='static/image/profile_default.svg', null=True, blank=True)
...
class hospital_department(models.Model):
    ...
    hospital_department_name = models.CharField(
    ...
    featured_image = models.ImageField(
        upload_to='departments/', default='departments/default.png', null=True, blank=True)
